...
class BinarySearchTree:
    ...
    def rotate_right(self) -> None:
        ...
        # min_node = self._right.minimum_node()
        # min_node._left = pivot._right

        new_self = BinarySearchTree(self._root)
        # new_self._left, new_self._right = self._left, self._right
        new_self._left, new_self._right = pivot._right, self._right

        self._right = new_self
    ...
    def rotate_left(self) -> None:
        ...
        new_self = BinarySearchTree(self._root)
        new_self._left, new_self._right = self._left, pivot._left
    ...
    def minimum_node(self) -> BinarySearchTree | None:
        if self._root is None:
            return None
